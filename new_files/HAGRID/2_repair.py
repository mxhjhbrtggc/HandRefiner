...
print("="*70)
print("步骤 2: 批量修复 HAGRID 图像")
print("="*70)

input_dir = '/workspace/datasets/HAGRID_512x512'
output_dir = '/workspace/output_hagrid_100'
